...
#define S3C2410_SPRDAT					(0x20)
#define S3C2410_SPPRE					(0x30)

#define S5L_SPRXC						(0x34)
#define S5L_SPTXC						(0x4c)
...
#define S5L_SPCON_FIFO_EN				(1 << 8)
#define S5L_SPCON_TXFIFO_EN				(1 << 21)
#define S5L_SPCON_RXFIFO_EN				(1 << 7)
